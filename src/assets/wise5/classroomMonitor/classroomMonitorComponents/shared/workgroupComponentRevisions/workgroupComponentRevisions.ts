                    ...
                    <div class="md-list-item-text component-revisions__item__text"
                        ...
                        <div style="padding: 20px;">
                            <ng-content ng-switch="item.componentState.componentType">
                              <div ng-switch-when="AudioOscillator|Draw|Label|Match|MultipleChoice|OpenResponse" ng-switch-when-separator="|" class="component__content" layout="row" layout-wrap>
