...
import { MatchSummaryDisplayDifferentiatorComponent } from '../../../../directives/teacher-summary-display/match-summary-display/match-summary-display-differentiator/match-summary-display-differentiator.component';
...
@Component({
  imports: [
    ...
    MatCardModule,
    MatchSummaryDisplayDifferentiatorComponent,
    MatIconModule,
    MatDividerModule,
