...
import { ExportGradebookComponent } from '../../assets/wise5/classroomMonitor/dataExport/export-gradebook/export-gradebook.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'export/gradebook', component: ExportGradebookComponent },
